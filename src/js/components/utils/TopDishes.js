...
render(){
  let dishesBoxStyle = {padding: "10px", height: "100%", background:"lightblue"}
  let scrollItemStyle = {paddingLeft: "7%", paddingRight: "7%"}
  ...
  return(
    <div style={dishesBoxStyle} className="hidden-xs centered shadow-container">
            <div style={{left: "1%", right: "1%"}} className="DishBoxAnim">
